  ...
  const fetchExperiences = async () => {
    try {
      ...
      if (data && data.length > 0) {
        ...
        setExperiences([
          { period: "2021 - Present", role: "Senior Video Editor", company: "Creative Agency Co.", description: "Lead editor for commercial and documentary projects. Color grading specialist." },
          { period: "2018 - 2021", role: "Freelance Videographer", company: "Self-Employed", description: "Shot and edited hundreds of weddings, corporate events, and music videos." },
          { period: "2016 - 2018", role: "Junior Editor", company: "Media House", description: "Assisted senior editors with rough cuts, syncing audio, and managing media assets." }
        ]);
      }
    } catch (error) {
