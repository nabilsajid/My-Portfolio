  ...
  const fetchAchievements = async () => {
    try {
      ...
      if (data && data.length > 0) {
        ...
        setAchievements([
          { title: "Best Documentary Award", role: "Director / Editor", icon: "Award", description: "Winner at the Independent Film Festival for 'Voices Unseen'." },
          { title: "National Campaign", role: "Lead Videographer", icon: "Video", description: "Shot the summer campaign for a major retail brand." },
          { title: "Published Editor", role: "Colorist", icon: "Camera", description: "Color graded a feature film that premiered on Netflix." },
          { title: "Creative Excellence", role: "Creator", icon: "Star", description: "Recognized by Adobe for outstanding motion graphics work." }
        ]);
      }
    } catch (error) {
