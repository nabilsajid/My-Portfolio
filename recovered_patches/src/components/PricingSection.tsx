  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xs italic text-muted-foreground mb-4">#{packet.best_for}</p>
...
const PricingSection = () => {
  ...
  return (
    <section id="pricing" className="section-padding max-w-6xl mx-auto">
      ...
      />
      <div className="flex flex-wrap justify-center gap-6 lg:gap-8 items-stretch lg:items-center">
        {packets.map((p, i) => (
